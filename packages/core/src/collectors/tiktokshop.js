...
class TikTokShopCollector extends base_1.BaseCollector {
    ...
    fetchMock() {
        ...
        const allMock = [
            ...
            { id: "tt-mock-005", title: "Battery dies in under 30 minutes", text: "The listing claims 8-hour battery life but in reality it lasts maybe 25 minutes before dying completely. False advertising everywhere.", stars: 2, createdAt: new Date(now - 18 * day).toISOString(), author: "tech_buyer_99" },
            { id: "tt-mock-006", title: "Seller blocked me after complaint", text: "Messaged seller about defective product and they immediately blocked me. Lost my money with zero recourse. TikTok Shop support is useless.", stars: 1, createdAt: new Date(now - 22 * day).toISOString(), author: "scammed_shopper" },
            { id: "tt-mock-007", title: "Glue came apart on first use", text: "The adhesive holding the parts together completely failed on first use. Glue is visible and the product fell apart. Very poor construction.", stars: 1, createdAt: new Date(now - 28 * day).toISOString(), author: "diy_reviewer" },
            // 中性 10% (1条)
            { id: "tt-mock-008", title: "Decent but not as advertised", text: "The product works but is noticeably smaller than shown in the video. Quality is average for the price. Shipping was fast. Would not buy again.", stars: 3, createdAt: new Date(now - 35 * day).toISOString(), author: "neutral_reviewer" },
            // 好评 20% (2条)
            { id: "tt-mock-009", title: "Great value, very happy", text: "Pleasantly surprised by the quality. Arrived in 5 days, well packaged. Functions exactly as described in the video. Would recommend to friends.", stars: 5, createdAt: new Date(now - 42 * day).toISOString(), author: "happy_buyer_tt" },
            { id: "tt-mock-010", title: "Exceeded my expectations", text: "Honestly did not expect much given the price but this product is solid. Build quality is better than similar items I have bought before. Very satisfied.", stars: 5, createdAt: new Date(now - 50 * day).toISOString(), author: "positive_shopper" },
        ];
